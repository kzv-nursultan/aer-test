...
export default function Sidebar() {
  return (
    <div data-testid="sidebar-id" className="h-screen w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
